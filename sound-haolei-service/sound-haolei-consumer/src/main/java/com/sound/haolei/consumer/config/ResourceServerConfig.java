package com.sound.haolei.consumer.config;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        oAuth2AuthenticationProcessingFilter.setAuthenticationEntryPoint(getExceptionEntryPoint());
        defaultTokenServices.setTokenStore(tokenStore());
        ...
        http
                .csrf().disable().addFilterBefore(oAuth2AuthenticationProcessingFilter,AbstractPreAuthenticatedProcessingFilter.class)
                .exceptionHandling()
